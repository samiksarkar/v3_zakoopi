...
/**
 * SaleTownMarketsFixture
 *
 */
class SaleTownMarketsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'market_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created_date' => '2015-05-20 07:28:41',
            'modified_date' => '2015-05-20 07:28:41',
            'status' => 1
        ],
    ];
}
