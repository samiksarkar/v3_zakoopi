...
/**
 * SaleTownStoresFixture
 *
 */
class SaleTownStoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'store_slug' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'store_slug' => 'Lorem ipsum dolor sit amet',
            'cover_photo' => 'Lorem ipsum dolor sit amet',
            'created_date' => '2015-05-20 07:28:42',
            'modified_date' => '2015-05-20 07:28:42',
            'status' => 1
        ],
    ];
}
