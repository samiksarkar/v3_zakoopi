<div class="row">
    <div class="col-lg-10">
        <div class = "homepageAds form large-10 medium-9 columns">
            <?= $this->Form->create($homepageAd);
            ?>
            <fieldset>
                <legend><?= __('Edit Homepage Ad') ?></legend>
                <?php
...
<?= $this->Form->end() ?>
    ...
    <div class="col-lg-2">
        <ul class="btn-group-vertical">
                ...
                $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $homepageAd->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $homepageAd->id)]
                )
                ?></li>
