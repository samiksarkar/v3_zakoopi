                ...
                <table class="table table-striped table-responsive table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                                                        ...
                                                        <td><?= h($style->name) ?></td>
                                                        <td><?= h($style->is_visible) ?></td>
                                                        <td class="actions">
                                <?= $this->Html->link(__('View'), ['action' => 'view', $style->id], ['class' => 'btn btn-default']) ?>
                                <?= $this->Html->link('<i class="fa fa-edit"></i>', ['action' => 'edit', $style->id], ['class' => 'btn btn-default', 'escape' => false]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $style->id], ['confirm' => __('Are you sure you want to delete # {0}?', $style->id), 'class' => 'btn btn-danger']) ?>
                            </td>
                        </tr>
