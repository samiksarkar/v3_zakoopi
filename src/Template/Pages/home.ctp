            ...
            <div class="row">
                <div class="home-discover-sec">
                    ...
                    <ul class="banner-tab" role="tablist">
                        <li role="presentation" class="active"><a href="#topmarket" aria-controls="topmarket" role="tab" data-toggle="tab">Top markets</a></li>
                        <li role="presentation"><a href="#toptrends" aria-controls="toptrends" role="tab" data-toggle="tab">Top trends</a></li>
                    </ul>
                    <div class="tab-content">
                        <div role="tabpanel" class="row1 tab-pane fade in active"  id="topmarket">
                            <div class="col-md-16 col-sm-16 ">
                                <ul class="bxslider">
                                    <li><a href="#"><img src="images/slider-img.jpg" alt="Sarojini Nagar" title="Sarojini Nagar" /></a> </li>
                                    <li><a href="#"><img src="images/slider-img.jpg" alt="Saket" title="Saket" /></a> </li>
                                    <li><a href="#"><img src="images/slider-img.jpg" alt="Sarojini Nagar" title="Sarojini Nagar" /></a> </li>
                                    <li><a href="#"><img src="images/slider-img.jpg" alt="Saket" title="Saket" /></a> </li>
                                    <li><a href="#"><img src="images/slider-img.jpg" alt="Sarojini Nagar" title="Sarojini Nagar" /></a> </li>
                                    <li><a href="#"><img src="images/slider-img.jpg" alt="Saket" title="Saket" /></a> </li>
                ...
                <div class="tab-content col-md-16 col-sm-16">
                    ...
                    <div role="tabpanel" class="row tab-pane fade"  id="hotdeals">
                        <ul class="hots-product" >
                            <li class="col-md-4 col-sm-4 col-xs-8">
                                <div class="hots-pro">
                                    <div class="hot-title">Ushnak Mal Mool Chand </div>
                            ...
                            <li class="col-md-4 col-sm-4 col-xs-8">
                                <div class="hots-pro  hot-pro-4">
                                    ...
                                    <div class="hots-pro-img"> <a href="#"><img src="images/photo-img8.png" alt="" /></a>
                                        ...
                                        <div class="discount-box"><span>50% OFF</span>on <br/>
                                            n Lehengas</div>
                                    </div>
                                    <div class="hot-share"> <a href="#"><img src="images/share-img.jpg"  alt=""/> <span>Share</span ></a> <a href="#"><img src="images/save-icon.jpg" alt="" /> <span>Save</span></a> </div>
                                    <div class="hot-share-bottom"> <span class="offer-txt">• Offer valid till June’15</span> </div>
