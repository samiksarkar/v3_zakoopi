<div class="row">
    <div class="col-lg-10">
        <div class = "storeAds form large-10 medium-9 columns">
            <?= $this->Form->create($storeAd);
            ?>
            <fieldset>
                <legend><?= __('Edit Store Ad') ?></legend>
                <?php
...
<?= $this->Form->end() ?>
    ...
    <div class="col-lg-2">
        <ul class="btn-group-vertical">
                ...
                $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $storeAd->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $storeAd->id)]
                )
                ?></li>
